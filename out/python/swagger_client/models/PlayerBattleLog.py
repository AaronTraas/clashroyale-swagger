...
class PlayerBattleLog(object):
    ...
    def __init__(self, battle=None):  # noqa: E501
        """PlayerBattleLog - a model defined in Swagger"""  # noqa: E501
        self._battle = None
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PlayerBattleLog):
            return False
